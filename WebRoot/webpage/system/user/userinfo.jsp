...
<t:formvalid formid="formobj" layout="div" dialog="true">
	...
	<div class="form">
		<c:if test="${memberflag == 1}"><a href = "${pageContext.request.contextPath}/staffController.do?search">个人详细信息</a></c:if>
		<c:if test="${ketangfalg == 1}"><a href = "${pageContext.request.contextPath}/pravrajanamemberController.do?update">个人详细信息</a></c:if>
