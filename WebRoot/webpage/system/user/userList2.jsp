...
<div style="float: left;"><a href="#" id="add" class="easyui-linkbutton" plain="true" icon="icon-add" onclick="add('用户录入','staffController.do?addorupdate','userList2')">用户录入</a> <a href="#"
	class="update" plain="true" icon="icon-edit" onclick="update('用户编辑','staffController.do?addorupdate','userList2')">用户编辑</a></div>
