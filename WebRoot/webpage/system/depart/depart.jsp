...
<t:formvalid formid="formobj" layout="div" dialog="true" action="systemController.do?saveDepart">
	...
	<fieldset class="step">
	<div class="form"><label class="Validform_label"> 部门名称: </label> <input name="departname" class="inputxt" value="${depart.departname }" validType="t_s_depart,departname,id" datatype="s2-10">
	<span class="Validform_checktip">部门名称在2~10位字符</span></div>
