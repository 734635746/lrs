	...
	<c:if test="${fn:length(livingmenberList)  <= 0 }">
			<tr>
				...
				<td align="center"><input style="width:20px;"  type="checkbox" name="ck"/></td>
				  ...
				  <td align="left"><input name="livingmenberList[0].name" maxlength="20" type="text" style="width:120px;" ></td>
   			</tr>
	</c:if>
	<c:if test="${fn:length(livingmenberList)  > 0 }">
		<c:forEach items="${livingmenberList}" var="poVal" varStatus="stuts">
			<tr>
				...
				<input name="livingmenberList[${stuts.index }].id"  value="${poVal.id }" type="hidden" >
				   <td align="left"><input name="livingmenberList[${stuts.index }].called" maxlength="10" value="${poVal.call }" type="text" style="width:120px;"></td>
				   <td align="left"><input name="livingmenberList[${stuts.index }].name" maxlength="20" value="${poVal.name }" type="text" style="width:120px;"></td>
   			</tr>
		</c:forEach>
	</c:if>	
	</tbody>
