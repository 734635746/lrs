...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="infoList" fitColumns="true" title="委托人基本信息" actionUrl="doritualinfoController.do?datagrid" idField="id" fit="true">
   ...
   <t:dgToolBar title="早普佛登记" icon="icon-edit" url="morningpforrController.do?forwardSelectRecord" funname="morningpforr"></t:dgToolBar>
