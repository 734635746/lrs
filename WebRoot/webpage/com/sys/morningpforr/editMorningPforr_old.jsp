...
#form h5{
 ...
 <body style="overflow-y: scroll" scroll="yes">
		<h4>编辑早普佛记录</h4><input type="button" value="预览" class="button" onclick = "preview()">
		...
		<form action="${pageContext.request.contextPath}/morningpforrController.do?getSerialAndSaveTablet" onsubmit="return myvalidate()" method="post">
