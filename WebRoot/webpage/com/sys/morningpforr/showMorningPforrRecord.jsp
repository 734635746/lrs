...
<html>
  ...
  <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/button.css">
  	...
  	function toMorningPforr(){
  		...
  		if(param == undefined || param == ''){
	  		...
	  		window.location.href = "${pageContext.request.contextPath}/morningpforrController.do?ToEditMorningPforr" + param;
  		}
  	...
  	function selectBox(){
		 ...
		 if(morningPforrId == "" || count > 5){
			...
			// var id0 = document.getElementById("id").value;
			 window.location.href="${pageContext.request.contextPath}/morningpforrController.do?ToEditMorningPforr"+"&morningPforrId=" + morningPforrId+param;
		 }
 ...
 <body style="overflow-y: scroll" scroll="yes">
		...
		<br><br>
		<c:if test="${empty morningpforrEntityList}">
			<tr>没有早普佛记录，请点击<input type="button" value="早普佛登记" class="button" onclick="toMorningPforr()">&nbsp;&nbsp;</tr>
			</c:if>
		</center>
 </body>