...
<html>
  <head>
   ...
   <%--  //<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/js/jquery.js"> --%>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/memorialtablet.js"></script>
	...
	function generateTmp(){
		...
		$.ajax({
	          url:"${pageContext.request.contextPath}/tmp_tableController.do?genereateTmp",
	          type:"post",
	          dataType:"text",
	          data:{
  ...
  <br><br><br><br><br>
	法事类型：${name} &nbsp;&nbsp;  
      ...
      打印序号：<input style="width:50px" type="text" id="start">----<input style="width:50px" type="text" id="end">
      <center>
      <br><br>
      <input type="button" class="button" value="打印牌位"  onclick="generateTmp()"> 
     </center>
