...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="attendanceList" title="早晚课诵考勤管理" actionUrl="attendanceController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="录入早晚课诵考勤" icon="icon-add" url="attendanceController.do?towardShowCrowdsRecord&type=1" funname="ShowCrowdsRecord" operationCode="add"></t:dgToolBar>
