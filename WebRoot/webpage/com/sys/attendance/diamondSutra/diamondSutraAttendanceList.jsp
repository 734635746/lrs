...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="diamondSutraAttendanceList" title="金刚经考勤管理" actionUrl="attendanceController.do?diamondSutraDatagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="录入金刚经考勤" icon="icon-add" url="attendanceController.do?towardShowCrowdsRecord&type=4" funname="ShowCrowdsRecord" operationCode="add"></t:dgToolBar>
