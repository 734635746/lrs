...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function mySub(){
			...
			var r=window.confirm("确定填写" + month + "的二时临斋考勤信息吗？");
	 		if (r==true)
	 		{
	 			window.location.href = "${pageContext.request.contextPath}/attendanceController.do?addTwoTimeLinZhaiRecord&allRecords=" + encodeURI(encodeURI(allRecords)) + "&dharmaname=" + encodeURI(encodeURI(dharmaname)) + "&month=" + encodeURI(encodeURI(month)) + "&year=" + year;
	 			return true;
	 		}
	 		else
	 		{
  ...
  <body>
	...
	<c:forEach var="i" begin="1" end="10" varStatus="status">
       	...
       	<tr>
             <td colspan="1" rowspan="2" width="50"><input style="width:50px;" type = "text" id = "${i}" value = "" readonly><%-- <br>外出<input type="radio" name="reasonMorning${i}" value="7" /> --%>
	...
	<c:forEach var="i" begin="11" end="20" varStatus="status">
       	...
       	<tr>
             <td colspan="1" rowspan="2" width="50"><input style="width:50px;" type = "text"  id = "${i}" value = "" readonly>
             <br><br><input type = "button" class = "button" value = "重置" onclick = "myReset('reason|${i}')"></td>
             <td width="200">
             	事假<input type="radio" name="reasonMorning${i}" value="1" />
       			迟到<input type="radio" name="reasonMorning${i}" value="2" />
