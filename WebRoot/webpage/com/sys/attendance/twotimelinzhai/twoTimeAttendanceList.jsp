...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="twoTimeAttendanceList" title="二时临斋考勤管理" actionUrl="attendanceController.do?twoTimeAttendanceDatagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="录入二时临斋考勤" icon="icon-add" url="attendanceController.do?towardShowCrowdsRecord&type=2" funname="ShowCrowdsRecord" operationCode="add"></t:dgToolBar>
