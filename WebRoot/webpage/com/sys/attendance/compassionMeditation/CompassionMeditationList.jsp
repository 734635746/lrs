...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="compassionMeditationList" title="大悲共修考勤管理" actionUrl="attendanceController.do?compassionMeditationDatagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="录入大悲共修考勤" icon="icon-add" url="attendanceController.do?towardShowCrowdsRecord&type=3" funname="ShowCrowdsRecord" operationCode="add"></t:dgToolBar>
