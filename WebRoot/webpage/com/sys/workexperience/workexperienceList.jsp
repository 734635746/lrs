	...
	<c:if test="${fn:length(workexperienceList)  <= 0 }">
			<tr>
				...
				<td align="center"><input style="width:20px;"  type="checkbox" name="ck"/></td>
				  ...
				  <td align="left"><input name="workexperienceList[0].arrivaldate" maxlength="" type="text" style="width:120px;" ></td>
				  <td align="left"><input name="workexperienceList[0].departuredate" maxlength="" type="text" style="width:120px;" ></td>
