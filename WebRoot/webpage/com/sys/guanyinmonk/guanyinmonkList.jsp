...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="guanyinmonkList" title="观音出家" actionUrl="guanyinmonkController.do?datagrid" idField="id" fit="true" sortName="registertime" queryMode="group">
  ...
  <%--  <t:dgCol title="操作" field="opt" width="100"></t:dgCol> --%>
   <%-- <t:dgDelOpt title="删除" url="guanyinmonkController.do?del&id={id}" /> --%>
   <t:dgToolBar title="查看" icon="icon-search" url="guanyinmonkController.do?addorupdate" funname="detail"></t:dgToolBar>
      <t:dgToolBar title="修改观音出家记录" icon="icon-search" url="guanyinmonkController.do?myUpdate" funname="ritualUpdate"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
  <script>
