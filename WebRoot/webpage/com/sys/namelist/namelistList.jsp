	...
	<c:if test="${fn:length(namelistList)  <= 0 }">
			<tr>
				...
				<td align="center"><input style="width:20px;"  type="checkbox" name="ck"/></td>
				  <td align="left"><input name="namelistList[0].name" maxlength="20" type="text" style="width:120px;" ></td>
				  <td align="left"><t:dictSelect field="state" typeGroupCode="mem_state" hasLabel="false" defaultVal="延生" type="radio">
		...
		<c:forEach items="${namelistList}" var="poVal" varStatus="stuts">
			<tr>
				...
				<input name="namelistList[${stuts.index }].id"  value="${poVal.id }" type="hidden" >
				   <td align="left"><input name="namelistList[${stuts.index }].name" maxlength="20" value="${poVal.name }" type="text" style="width:120px;"></td>
