...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="diamondsutraList" title="金刚经管理" actionUrl="diamondsutraController.do?datagrid" idField="id" fit="true">
   ...
   <t:dgCol title="委托人" field="prayingobj" query="true"></t:dgCol>
   <t:dgCol title="祈福对象" field="livingmember" ></t:dgCol>
  ...
  <%--  <t:dgCol title="操作" field="opt" width="100"></t:dgCol>
   <t:dgDelOpt title="删除" url="diamondsutraController.do?del&id={id}" /> --%>
   <t:dgToolBar title="录入" icon="icon-add" url="diamondsutraController.do?toAddDiamondsutra" funname="diamondregister"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>