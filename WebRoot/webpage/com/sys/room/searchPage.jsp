  ...
  <style>
    .footer{position: absolute;bottom: 30px;left: 0;height: 20px;width: 100%;}
  	...
  	function toBookRoom(){
    	...
    	href = "${pageContext.request.contextPath}/registrationroomController.do?addorupdate&intakentime=" + intakentime
    			+ "&leavetime=" + leavetime + "&roomid=" + roomids + "&bookflag=yes";
...
<br>
<center>
<input type = "button" value = "入住登记" onclick="toBookRoom()" class="button"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</center>
</body>
