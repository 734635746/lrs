...
<html>
 ...
 <body style="overflow-y: hidden" scroll="no">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="jIzobirthController.do?save">
			<input id="id" name="id" type="hidden" value="${jIzobirthPage.id }">
				...
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="registertime" name="registertime" ignore="ignore"
							   value="${jIzobirthPage.registertime}">
				...
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="registrant" name="registrant" ignore="ignore"
							   value="${jIzobirthPage.registrant}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="prayingobj" name="prayingobj" ignore="ignore"
							   value="${jIzobirthPage.prayingobj}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="money" name="money" ignore="ignore"
							   value="${jIzobirthPage.money}" datatype="n">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
