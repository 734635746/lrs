...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="jIzobirthList" title="地藏诞" actionUrl="jIzobirthController.do?datagrid" idField="id" fit="true" sortName="registertime" queryMode="group">
 ...
 <%--   <t:dgDelOpt title="删除" url="jIzobirthController.do?del&id={id}" /> --%>
   <t:dgToolBar title="查看" icon="icon-search" url="jIzobirthController.do?addorupdate" funname="detail"></t:dgToolBar>
   <t:dgToolBar title="修改地藏诞记录" icon="icon-search" url="jIzobirthController.do?myUpdate" funname="ritualUpdate"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
  <script>
