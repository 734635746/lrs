...
<div style="padding: 3px; height: 35px;width:auto;" class="datagrid-toolbar"><a id="delVolunteereventBtn" href="#">删除</a>
		<%-- ${${isconfirm}}
		<c:if test="${isconfirm == null}">
			<a id="delVolunteereventBtn" href="#">删除</a>
		</c:if>
		<c:if test="${isconfirm eq '否'}">
			<a id="delVolunteereventBtn" href="#">删除</a>
		</c:if> --%>
</div>
...
<script>
		...
		function on(){
			var temp = document.getElementById("input-21d");
			var temp1 = document.getElementById("input-211");
			var temp2 = document.getElementById("input-212");
			var temp3 = document.getElementById("input-213");
			var temp4 = document.getElementById("input-214");
			alert(temp.value);
			alert(temp1.value);
			alert(temp2.value);
			alert(temp3.value);
