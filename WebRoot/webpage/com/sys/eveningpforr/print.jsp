  ...
  <head>
   ...
   <%--  //<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/js/jquery.js"> --%>
	...
	function generatePaiwei(){
		...
		$.ajax({
	          url:"${pageContext.request.contextPath}/eveningpforrController.do?printMorningpforrPaiwei",
	          type:"post",
	          dataType:"text",
	          data:{
...
function generateWenshu(){
		...
		$.ajax({
	          url:"${pageContext.request.contextPath}/eveningpforrController.do?printMorningforrWenshu",
	          type:"post",
	          dataType:"text",
	          data:{
	        	solarstart:solarstart,
	          ...
	          /* alert("responseText"); */
	        	...
	        	if(responseText == "找不到适合条件的牌位"){
	        		alert("找不到适合条件的牌位");
	        		return ;
	        	}else if(responseText == "system error"){
	        		alert("系统发生错误，请与系统管理员联系");
	        		return ;
	        	}else if(responseText == "data error"){
	        		alert("要打印的牌位存在“历代宗亲”未填写的情况,请修改");
	        		return ;
	        	}
	        	else{
	        		alert("已生成文疏");
  ...
  <br><br><br><br>
	 <p>
      <label>需要打印的时间段:</label><input type="date" name="solarstart" id="solarstart" onchange="changeSolarToLunar(this,'#lunarstart');">----<input type="date" name="solarend" id="solarend" onchange="changeSolarToLunar(this, '#lunarend');">
     </p>
      <br>
     <p>
      <label>农历:</label><input type="text" id="lunarstart" placeholder="选择公历自动生成农历">----<input type="text" id="lunarend" placeholder="选择公历自动生成农历">
     </p>
      <br><br>
