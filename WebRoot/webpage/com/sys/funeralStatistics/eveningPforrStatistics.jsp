...
function getData(){
	...
	var url = "attendanceController.do?eveningPforrStatisticsResult&month=" + encodeURIComponent(encodeURIComponent(month)) + "&name=" + encodeURIComponent(encodeURIComponent(name))+ "&year=" + year;
	$.ajax({
		type : 'POST',
		url : url,
