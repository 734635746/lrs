...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="goddessbirthList" title="观音诞信息" actionUrl="goddessbirthController.do?datagrid" idField="id" fit="true" sortName="registertime" queryMode="group">
  ...
  <%--  <t:dgDelOpt title="删除" url="goddessbirthController.do?del&id={id}" /> --%>
   <t:dgToolBar title="查看" icon="icon-search" url="goddessbirthController.do?addorupdate" funname="detail"></t:dgToolBar>
   <t:dgToolBar title="修改观音诞记录" icon="icon-search" url="goddessbirthController.do?myUpdate" funname="ritualUpdate"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
