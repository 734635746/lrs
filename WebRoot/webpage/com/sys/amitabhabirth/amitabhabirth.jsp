...
<html>
 ...
 <body style="overflow-y: hidden" scroll="no">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="amitabhabirthController.do?save">
			<input id="id" name="id" type="hidden" value="${amitabhabirthPage.id }">
				...
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="registertime" name="registertime" ignore="ignore"
							   value="${amitabhabirthPage.registertime}">
				...
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="registrant" name="registrant" ignore="ignore"
							   value="${amitabhabirthPage.registrant}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="serial" name="serial" ignore="ignore"
							   value="${amitabhabirthPage.serial}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="prayingobj" name="prayingobj" ignore="ignore"
							   value="${amitabhabirthPage.prayingobj}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="ancestor" name="ancestor" ignore="ignore"
							   value="${amitabhabirthPage.ancestor}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="money" name="money" ignore="ignore"
							   value="${amitabhabirthPage.money}" datatype="n">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="payway" name="payway" ignore="ignore"
							   value="${amitabhabirthPage.payway}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="summary" name="summary" ignore="ignore"
							   value="${amitabhabirthPage.summary}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="receiptno" name="receiptno" ignore="ignore"
							   value="${amitabhabirthPage.receiptno}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="address" name="address" ignore="ignore"
							   value="${amitabhabirthPage.address}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
			</table>
