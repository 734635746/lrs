...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="amitabhabirthList" title="弥陀诞信息" actionUrl="amitabhabirthController.do?datagrid" idField="id" fit="true" sortName="registertime" queryMode="group">
...
<%--    <t:dgCol title="是否已打印" field="flag" replace="已打印_1,未打印_0" query="true"></t:dgCol> --%>
  ...
  <%--  <t:dgDelOpt title="删除" url="amitabhabirthController.do?del&id={id}" /> --%>
   <t:dgToolBar title="查看" icon="icon-search" url="amitabhabirthController.do?addorupdate" funname="detail"></t:dgToolBar>
   <t:dgToolBar title="修改弥陀诞记录" icon="icon-search" url="amitabhabirthController.do?myUpdate" funname="ritualUpdate"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
 <script>
