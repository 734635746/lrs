...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="guanyingayaList" title="观音成道信息表" actionUrl="guanyingayaController.do?datagrid" idField="id" fit="true" sortName="registertime" queryMode="group">
 ...
 <%--   <t:dgCol title="是否已打印" field="flag" replace="已打印_1,未打印_0"  query="true"></t:dgCol> --%>
  ...
  <%--  <t:dgDelOpt title="删除" url="guanyingayaController.do?del&id={id}" /> --%>
   <t:dgToolBar title="查看" icon="icon-search" url="guanyingayaController.do?addorupdate" funname="detail"></t:dgToolBar>
      <t:dgToolBar title="修改观音成道记录" icon="icon-search" url="guanyingayaController.do?myUpdate" funname="ritualUpdate"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
  <script>
