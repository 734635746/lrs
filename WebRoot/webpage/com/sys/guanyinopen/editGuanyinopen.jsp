...
#form h5{
 ...
 <h4>编辑观音开库记录</h4>
		...
		<table id = "receipttable" class="imagetable">
			...
			<c:forEach items="${guanyinopenEntitys}" var="guanyinopenEntitys" varStatus="stauts">
				<tr>
					<td><input style="width:20px;"  type="checkbox"/></td>
				 	<td><input style="width:100px;" type="text" id = "prayingobj" name="prayingobj" value="${guanyinopenEntitys.prayingobj}"></td>
				 	<td onclick="getSelected(this)"><input type="text" name="livingmenber" id = "livingmenber" value="${guanyinopenEntitys.livingmenber}"></td>
				 	<%-- <td><input type="text" id = "address" name="address" value="${guanyinopenEntitys.address}"></td> --%>
				 	<input type="hidden" id = "address" name="address" value="${guanyinopenEntitys.address}">
<%-- 				 	<input type="hidden" id = "address" name="address" value="${updateFlag!=1? doritualinfoAddress:guanyinopenEntitys.address}"> --%>
				 	<td><input style="width:40px;" type="text" id = "money" name="money" value="${guanyinopenEntitys.money}" ></td>
				 	<td>
					...
					<select style="width:50px;" id="size" name="size" onchange="changeSize(this.value);">
				 	...
				 	<td><textarea rows="3" cols="60" id="summary" name="summary" required>${guanyinopenEntitys.summary}</textarea>
					</td>
