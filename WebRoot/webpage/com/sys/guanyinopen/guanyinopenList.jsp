...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="guanyinopenList" title="观音开库" actionUrl="guanyinopenController.do?datagrid" idField="id" fit="true" sortName="registertime" queryMode="group">
  ...
  <%--  <t:dgDelOpt title="删除" url="guanyinopenController.do?del&id={id}" /> --%>
   <t:dgToolBar title="查看" icon="icon-search" url="guanyinopenController.do?addorupdate" funname="detail"></t:dgToolBar>
      <t:dgToolBar title="修改观音开库记录" icon="icon-search" url="guanyinopenController.do?myUpdate" funname="ritualUpdate"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
  <script>
