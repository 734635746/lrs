...
<html>
 ...
 <body style="overflow-y: hidden" scroll="no">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="receiptController.do?save&cancel=1">
			...
			<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
						<textarea rows="5" cols="70" id="cancelreason" name="cancelreason" autofoucus>${receiptPage.cancelreason}</textarea>
					</td>
				</tr>
			</table>
		</t:formvalid>
