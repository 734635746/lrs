...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="conreceiptList" title="收据表" actionUrl="receiptController.do?condatagrid" idField="id" fit="true">
  ...
  <%--  <t:dgCol title="操作" field="opt" width="100"></t:dgCol>
   ...
   <t:dgToolBar title="录入开光收入" icon="icon-add" url="receiptController.do?conToward" funname="conregister"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>