...
<div class="easyui-layout" fit="true">
  ...
  <!-- datagrid 的name不能与其他文件的datagrid name 相同，否则加载时只会加载一个 -->
  <t:datagrid name="infoList3" fitColumns="true" title="委托人基本信息" actionUrl="doritualinfoController.do?datagrid" idField="id" fit="true">
   ...
   <t:dgToolBar title="放生登记" icon="icon-edit" url="freeLivesController.do?forwardSelectRecord" funname="morningpforr"></t:dgToolBar>
