...
<table border="0" cellpadding="2" cellspacing="0" id="ancestor_table">
	<tr bgcolor="#E6E6E6">
		...
		<td align="center" bgcolor="#EEEEEE">操作</td>
				  <td align="left" bgcolor="#EEEEEE">往生者 称呼</td>
				  <td align="left" bgcolor="#EEEEEE">往生者 姓名</td>
	</tr>
	...
	<c:if test="${fn:length(ancestorList)  <= 0 }">
			<tr>
				...
				<td align="center"><input style="width:20px;"  type="checkbox" name="ck"/></td>
				  ...
				  <td align="left"><input name="ancestorList[0].name" maxlength="20" type="text" style="width:200px;"></td>
   			</tr>
	</c:if>
	<c:if test="${fn:length(ancestorList)  > 0 }">
		<c:forEach items="${ancestorList}" var="poVal" varStatus="stuts">
			<tr>
				...
				<input name="ancestorList[${stuts.index }].id"  value="${poVal.id }" type="hidden" >
				   <td align="left"><input name="ancestorList[${stuts.index }].called" maxlength="10" value="${poVal.called }" type="text" style="width:120px;"></td>
				   <td align="left"><input name="ancestorList[${stuts.index }].name" maxlength="20" value="${poVal.name }" type="text" style="width:200px;"></td>
   			</tr>
		</c:forEach>
	</c:if>	
	</tbody>
