...
<html>
 ...
 <body style="overflow-y: hidden" scroll="no">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tombsweepfesController.do?save">
			<input id="id" name="id" type="hidden" value="${tombsweepfesPage.id }">
				...
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="registertime" name="registertime" ignore="ignore"
							   value="${tombsweepfesPage.registertime}">
				...
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="registrant" name="registrant" ignore="ignore"
							   value="${tombsweepfesPage.registrant}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="prayingobj" name="prayingobj" ignore="ignore"
							   value="${tombsweepfesPage.prayingobj}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="ancestor" name="ancestor" ignore="ignore"
							   value="${tombsweepfesPage.ancestor}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="money" name="money" ignore="ignore"
							   value="${tombsweepfesPage.money}" datatype="n">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="summary" name="summary" ignore="ignore"
							   value="${tombsweepfesPage.summary}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="receiptno" name="receiptno" ignore="ignore"
							   value="${tombsweepfesPage.receiptno}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="address" name="address" ignore="ignore"
							   value="${tombsweepfesPage.address}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
			</table>
