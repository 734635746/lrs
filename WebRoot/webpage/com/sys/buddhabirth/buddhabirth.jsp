...
<html>
 ...
 <body style="overflow-y: hidden" scroll="no">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="buddhabirthController.do?save">
			<input id="id" name="id" type="hidden" value="${buddhabirthPage.id }">
				...
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="registertime" name="registertime" ignore="ignore"
							   value="${buddhabirthPage.registertime}">
				...
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="registrant" name="registrant" ignore="ignore"
							   value="${buddhabirthPage.registrant}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="prayingobj" name="prayingobj" ignore="ignore"
							   value="${buddhabirthPage.prayingobj}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="livingmenber" name="livingmenber" ignore="ignore"
							   value="${buddhabirthPage.livingmenber}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="money" name="money" ignore="ignore"
							   value="${buddhabirthPage.money}" datatype="n">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="receiptno" name="receiptno" ignore="ignore"
							   value="${buddhabirthPage.receiptno}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
