...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="ghostfesList" title="盂兰节" actionUrl="ghostfesController.do?datagrid" idField="id" fit="true" sortName="registertime" queryMode="group">
 ...
 <%--   <t:dgCol title="是否已打印" field="flag" replace="已打印_1,未打印_0"  query="true"></t:dgCol> --%>
  ...
  <%--  <t:dgDelOpt title="删除" url="ghostfesController.do?del&id={id}" /> --%>
   <t:dgToolBar title="查看" icon="icon-search" url="ghostfesController.do?addorupdate" funname="detail"></t:dgToolBar>
   <t:dgToolBar title="修改盂兰节记录" icon="icon-search" url="ghostfesController.do?myUpdate" funname="ritualUpdate"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
  <script>
