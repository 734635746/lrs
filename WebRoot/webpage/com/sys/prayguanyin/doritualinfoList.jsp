...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="infoList2" fitColumns="true" title="委托人基本信息" actionUrl="doritualinfoController.do?datagrid" idField="id" fit="true">
   ...
   <t:dgToolBar title="上供登记" icon="icon-edit" url="prayguanyinController.do?forwardSelectRecord" funname="prayguanyin"></t:dgToolBar>
