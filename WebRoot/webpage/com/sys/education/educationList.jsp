	...
	<c:if test="${fn:length(educationList)  <= 0 }">
			<tr>
				...
				<td align="center"><input style="width:20px;"  type="checkbox" name="ck"/></td>
				  <td align="left"><input name="educationList[0].starttime" maxlength="" type="text" style="width:120px;" ></td>
				  <td align="left"><input name="educationList[0].endtime" maxlength="" type="text" style="width:120px;" ></td>
