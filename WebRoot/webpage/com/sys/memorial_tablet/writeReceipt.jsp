...
<html>
 ...
 <br><br><br>
 <center>
 <form action="${pageContext.request.contextPath}/memorial_tabletController.do?saveTabletReceipt" onsubmit="return myvalidate()" method="post"">
 <table id = "receipttable" class="imagetable">
			...
			<tr>
					<th>用途</th>
					<td><input style="width:100px;" type="text" id = "purpose" name="purpose"></td>
				</tr>
			<tr>
				<th>摘要</th>
				<td><textarea rows="3" cols="50" id="summary" name="summary">${summary}</textarea></td>
			</tr>
		</table>
		<br>
