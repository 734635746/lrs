	...
	<c:if test="${fn:length(linkmanlistList)  <= 0 }">
			<tr>
				...
				<td align="center"><input style="width:20px;"  type="checkbox" name="ck"/></td>
				  ...
				  <td align="left"><input name="linkmanlistList[0].relationship" maxlength="36" type="text" style="width:120px;" ></td>
   			</tr>
	</c:if>
	<c:if test="${fn:length(linkmanlistList)  > 0 }">
		<c:forEach items="${linkmanlistList}" var="poVal" varStatus="stuts">
			<tr>
				...
				<input name="linkmanlistList[${stuts.index }].id"  value="${poVal.id }" type="hidden" >
				   ...
				   <td align="left"><input name="linkmanlistList[${stuts.index }].relationship" maxlength="36" value="${poVal.relationship }" type="text" style="width:120px;"></td>
   			</tr>
		</c:forEach>
	</c:if>	
	</tbody>
