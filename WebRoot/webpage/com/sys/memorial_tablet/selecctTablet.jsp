  	...
  	//var dharmaname = 
  	 function mySubmit(){
    	 ...
    	 var dan_name =   encodeURI(document.getElementById("dan_name").value) ;
  		 ...
  		 window.location.href="${pageContext.request.contextPath}/memorial_tabletController.do?registerTabletInfo&selectedTablet=" + selectedTablet + "&building_name=" + encodeURI(building_name) + "&dan_name=" + encodeURI(dan_name);
  	 }
