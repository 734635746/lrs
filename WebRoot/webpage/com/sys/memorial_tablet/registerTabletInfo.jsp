...
<html>
 ...
 <body style="overflow-y: hidden" scroll="no">
  <form action="${pageContext.request.contextPath}/memorial_tabletController.do?saveTablet" method="post">
			<input id="id" name="id" type="hidden" value="${memorial_tabletPage.id }">
			
			<table class="imagetable">
			<tr>
			<th align="right"><label class="Validform_label">编号:</label></th>
			<td class="value">
				<input nullmsg="请填写编号" errormsg="编号格式不对" class="inputxt" id="serial" name="serial" ignore="ignore"
									   value="${memorial_tabletPage.serial}" datatype="n"  style="width: 220px">
								<span class="Validform_checktip"></span>
			</td>
			<th align="right"><label class="Validform_label">堂口:</label></th>
			<td class="value">
				<input nullmsg="请填写堂口" errormsg="堂口格式不对" class="inputxt" id="buildingName" name="buildingName" ignore="ignore"
									   value="${memorial_tabletPage.buildingName}" readonly>
								<span class="Validform_checktip"></span>
			</td>
			</tr>
			<tr>
			<th align="right"><label class="Validform_label">段位:</label></th>
			<td class="value">
				<input nullmsg="请填写段位" errormsg="段位格式不对" class="inputxt" id="dan" name="dan" ignore="ignore"
									   value="${memorial_tabletPage.dan}" readonly>
								<span class="Validform_checktip"></span>
			</td>
			<th align="right"><label class="Validform_label">行号:</label></th>
			<td class="value">
				<input nullmsg="请填写行号" errormsg="行号格式不对" class="inputxt" id="row" name="row" ignore="ignore"
									   value="${memorial_tabletPage.row}" datatype="n" readonly>
								<span class="Validform_checktip"></span>
			</td>
			</tr>
			<tr>
			<th align="right"><label class="Validform_label">列号:</label></th>
			<td class="value">
				<input nullmsg="请填写位号" errormsg="位号格式不对" class="inputxt" id="ordernumber" name="ordernumber" ignore="ignore"
									   value="${memorial_tabletPage.ordernumber}" datatype="n" readonly>
								<span class="Validform_checktip"></span>
			</td>
			<th align="right"><label class="Validform_label">大小:</label></th>
			<td class="value">
			...
			<td class="value">
				<input nullmsg="请填写安位时间"  class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  style="width: 150px" id="comforttime" name="comforttime" ignore="ignore"
									     value="<fmt:formatDate value='${memorial_tabletPage.comforttime}' type="date" pattern="yyyy-MM-dd"/>" datatype="*">
								<span class="Validform_checktip"></span>
			</td>
			</tr>
			<tr>
			...
			<td class="value">
				<input nullmsg="请填写开始时间"  class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  style="width: 150px" id="begintime" name="begintime" ignore="ignore"
									     value="<fmt:formatDate value='${memorial_tabletPage.begintime}' type="date" pattern="yyyy-MM-dd"/>" datatype="*">
								<span class="Validform_checktip"></span>
			</td>
			<th align="right"><label class="Validform_label">结束时间:</label></th>
			<td class="value">
				<input nullmsg="请填写结束时间"  class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  style="width: 150px" id="endtime" name="endtime" ignore="ignore"
									     value="<fmt:formatDate value='${memorial_tabletPage.endtime}' type="date" pattern="yyyy-MM-dd"/>" datatype="*">
								<span class="Validform_checktip"></span>
			</td>
			</tr>
			</table>
