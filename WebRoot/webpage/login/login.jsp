...
<body>
    ...
    <div id="login">
        ...
        <div class="inner">
            <div class="logo"><!-- <img src="plug-in/login/images/head.png" /><img src="plug-in/login/images/foot.png" /> --><p><font size="5">六榕寺信息管理系统</font></p></div>
            <div class="formLogin">
                <form name="formLogin" id="formLogin" action="loginController.do?login" check="loginController.do?checkuser" method="post">
                  ...
                  <%--   update-begin--Author:kooking  Date:20180326 for:应甲方要求，去掉验证码
                   <div class="tip">
                    ...
                    <div class="loginButton">
                        <%-- <div style="float: left; margin-left: -9px;">修改底部记住用户名按钮位置，使其居中  --%>
                        ...
                        <%-- <div style="float: right; padding: 3px 0; margin-right: -12px;">修改登陆重置按钮位置，使其居中 --%>
                        <div style="float: right; padding: 3px 0; margin-right: 95px;">
                            <div>
    ...
    <div class="clear"></div>
    <div id="versionBar">
        <div class="copyright">&copy; 版权所有 <span class="tip"><a href="#" title="六榕寺信息管理系统">六榕寺</a> (推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度)技术支持:<a href="#" title="六榕寺信息管理系统">jeecg</a></span></div>
    </div>
    <!-- Link JScript-->
