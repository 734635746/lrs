...
<!-- 顶部-->
<div region="north" border="false" title="" style="BACKGROUND: #f7f995; height: 105px; padding: 1px; overflow: hidden;">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<div style="position: absolute; top: 78px; left: 33px;">六榕寺 <span style="letter-spacing: -1px;">信息管理系统</span></div>
		</td>
		...
		<table border="0" cellpadding="0" cellspacing="0">
			<tr style="height: 25px;" align="right">
				...
				<div style="float: left; line-height: 25px; margin-left: 70px;"><span style="color: #386780">当前用户:</span> <span style="color: black">${userName }</span>&nbsp;&nbsp;&nbsp;&nbsp; <span
					style="color: #386780">职务:</span> <span style="color: black">${roleName }</span></div>
				<div style="float: left; margin-left: 18px;">
				<div style="right: 0px; bottom: 0px;"><a href="javascript:void(0);" class="easyui-menubutton" menu="#layout_north_kzmbMenu" iconCls="icon-comturn" style="color: black">控制面板</a>&nbsp;&nbsp;<a
					href="javascript:void(0);" class="easyui-menubutton" menu="#layout_north_zxMenu" iconCls="icon-exit" style="color: black">注销</a></div>
...
<!-- 左侧-->
<div region="west" split="true" href="loginController.do?shortcut_top" title="导航菜单" style="width: 160px; padding: 1px;"></div>
<!-- 中间-->
...
<div align="center" style="color: #1fa3e5; padding-top: 2px">&copy; 版权所有 <span class="tip"><a href="" title="六榕寺版本">六榕寺</a> (推荐谷歌浏览器，获得更快响应速度) 技术支持:<a href="#" title="六榕寺版本">六榕寺</a> </span></div>
</div>
