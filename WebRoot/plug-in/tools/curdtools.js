...
/* 法事登记弹窗*/
function rigister(title,url,id,width,height) {
	gridname=id;
	var rowsData = $('#'+id).datagrid('getSelections');
	/*if (!rowsData || rowsData.length==0) {
		tip('请选择编辑项目');
...
function print(title,url,id,width,height) {
	...
	openwindow('打印牌位',url,'',700,300);
}
function conregister(title,url,id,width,height) {
	
	openwindow('开光登记',url,'',700,400);
}

function free(title,url,id,width,height) {
	
	openwindow('放生登记',url,'',1200,600);
}

function fundregister(title,url,id,width,height) {
	
	openwindow('善款登记',url,'',700,400);
}
function diamondregister(title,url,id,width,height) {
	
	openwindow('金刚经登记',url,'',800,500);
}
function continuousregister(title,url,id,width,height) {
	
	openwindow('长明灯登记',url,'',800,500);
}
function gongzhairegister(title,url,id,width,height) {
	
	openwindow('供斋登记',url,'',800,500);
}
function ShowCrowdsRecord(title,url,id,width,height) {
	
	openwindow('考勤管理',url,'',1100,600);
}

/*早普佛登记弹窗*/
function morningpforr(title,url,id,width,height) {
	gridname=id;
	...
	openwindow(title,url,'',1520,600);
}

/*早普佛修改记录弹窗*/
function morningpforUpdate(title,url,id,width,height) {
	gridname=id;
	...
	url += '&id='+rowsData[0].id;
	openwindow(title,url,'',1540,600);
}


/*晚普佛登记弹窗 */
function eveningpforr(title,url,id,width,height) {
	gridname=id;
...
//	openwindow(title,url,'',1200,600);
	openwindow(title,url,'',1540,600);	
}

/*晚普佛修改记录弹窗*/
function eveningpforUpdate(title,url,id,width,height) {
	gridname=id;
...
/*上供弹窗*/
function prayguanyin(title,url,id,width,height) {
	gridname=id;
...
//	url += '&id='+rowsData[0].id;
//	openwindow(title,url,'',1200,600);
	openwindow(title,url,'',1450,598);
}


/*上供修改记录弹窗*/
function prayguanyinUpdate(title,url,id,width,height) {
	gridname=id;
...
function towardWareHousing(title,url,id,width,height) {
	
	openwindow(title,url,'',1000,600);
}
function towardDelivery(title,url,id,width,height) {
...
function towardRegisterTablet(title,url,id,width,height) {
	
	openwindow(title,url,'',1300,600);
}


/*功德堂牌位移位 */
function memorialMove(title,url,id,width,height) {
	gridname=id;
