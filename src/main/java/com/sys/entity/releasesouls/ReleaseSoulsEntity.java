package com.sys.entity.releasesouls;
...
/**
* @ClassName: ReleaseSoulsEntity
* @Description: 超度类法事总表，同doritualid同size只保持10条记录
* @author kooking
* @date 2018-5-8 下午4:31:36
*/ 
@Entity
@Table(name = "release_souls", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class ReleaseSoulsEntity implements Serializable{
	...
	@Column(name ="PAYMEN",nullable=true)
