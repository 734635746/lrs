package com.sys.entity.continuouslight;
 ...
 */
@Entity
@Table(name = "continuouslight", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class ContinuouslightEntity implements java.io.Serializable {
	/**id*/
	...
	/**到期标志*/
	private java.lang.Integer deadlineflag;
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  duration
	 */
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  duration
	 */
	...
	/**
	 *方法: 取得java.lang.Integer
	 *@return: java.lang.Integer  days
	 */
	@Column(name ="DAYS",nullable=true,precision=10,scale=0)
	...
	@Column(name ="DEADLINEFLAG",nullable=true)
	public java.lang.Integer getDeadlineflag() {
		return deadlineflag;
	}

	public void setDeadlineflag(java.lang.Integer deadlineflag) {
