package com.sys.entity.eveningpforr;
 ...
 * @Description: 晚普佛管理
 * @author zhangdaihao
 * @date 2016-10-10 15:49:53
 * @version V1.0   
 *
 */
@Entity
@Table(name = "eveningpforr", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class EveningpforrEntity implements java.io.Serializable {
	/**id*/
