package com.sys.entity.tombsweepfes;
 ...
 */
@Entity
@Table(name = "tombsweepfes", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class TombsweepfesEntity implements java.io.Serializable {
	/**id*/
	 ...
	 */
	@Column(name ="SERIAL",nullable=true,precision=11,scale=0)
