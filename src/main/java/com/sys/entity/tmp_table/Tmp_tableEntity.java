package com.sys.entity.tmp_table;
 ...
 */
@Entity
@Table(name = "tmp_table", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class Tmp_tableEntity implements java.io.Serializable {
	/**id*/
	 ...
	 */
	@Column(name ="PRAYINGOBJ",nullable=true,length=20)
