package com.sys.entity.livingmenber;
 ...
 * @Description: 在世的人
 * @author zhangdaihao
 * @date 2015-11-25 15:49:00
 * @version V1.0   
 *
 */
@Entity
@Table(name = "livingmenber", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class LivingmenberEntity implements java.io.Serializable {
	/**id*/
