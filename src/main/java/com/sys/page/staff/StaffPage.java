...
public class StaffPage implements java.io.Serializable {
	/**保存-工作经历*/
	private List<WorkexperienceEntity> workexperienceList = new ArrayList<WorkexperienceEntity>();
	public List<WorkexperienceEntity> getWorkexperienceList() {
		return workexperienceList;
	}
	public void setWorkexperienceList(List<WorkexperienceEntity> workexperienceList) {
	...
	/**保存-家庭成员*/
	private List<FamilymemberEntity> familymemberList = new ArrayList<FamilymemberEntity>();
	public List<FamilymemberEntity> getFamilymemberList() {
		return familymemberList;
	}
	public void setFamilymemberList(List<FamilymemberEntity> familymemberList) {
