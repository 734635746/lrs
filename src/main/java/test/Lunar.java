...
public class Lunar {
	...
	static SimpleDateFormat chineseDateFormat = new SimpleDateFormat("yyyy-M-d");
	...
	public String toString() {
		return year + " " + (leap ? "闰" : "") + chineseNumber[month - 1] + "月" + " " + getChinaDayString(day);
	}

	public static void main(String[] args) throws ParseException {
		Calendar today = Calendar.getInstance();
		today.setTime(chineseDateFormat.parse("2003-1-23"));
		Lunar lunar = new Lunar(today);
		System.out.println(lunar.toString().split(" ")[2]);
