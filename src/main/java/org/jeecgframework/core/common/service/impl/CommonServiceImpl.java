...
public class CommonServiceImpl implements CommonService {
	...
	* @return 查询结果
	* @see org.jeecgframework.core.common.service.CommonService#listByProcNLimit(java.lang.Class, int, int, java.lang.String, java.lang.Object[])
	*/ 
	@Override
	public <T> List<T> listByProcNLimit(Class<T> entitycClass, int firstResult,
			int maxResult, String sql, Object... param) {
		
		return this.commonDao.listByProcNLimit(entitycClass, firstResult, maxResult, sql, param);
	}
	...
	* @param param sql语句的参数
	* @return 查询结果
	* @see org.jeecgframework.core.common.service.CommonService#listBySQL(java.lang.Class, java.lang.String, java.lang.Object[])
	*/ 
	@Override
	public <T> List<T> listBySQL(Class<T> entitycClass, String sql,
			Object... param) {
		return this.commonDao.listBySQL(entitycClass, sql, param);
	}

	@Override
	public void executeSQLProc(String sql, Object... param) {
		this.commonDao.executeSQLProc(sql, param);
